...
<article class="card flex flex-col">
    ...
    <div class="card-body flex-1 flex flex-col">
        ...
        <p class="text-gray-500 text-sm mb-2 mt-auto">Prof: {{$course->teacher->name}} {{$course->teacher->lastname}}</p>
        <div class="flex">
        ...
        <a href="{{route('courses.show', $course)}}" class="bg-blue-500 p-2 w-full rounded text-white text-center font-bold">
            Mas Info...
        </a>
    </div>
</article>